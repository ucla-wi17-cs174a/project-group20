  ...
  { 'construct': function( context )     // third-person style camera matrix controls to the canvas.
    ...
    'init_keys': function( controls )   // init_keys():  Define any extra keyboard shortcuts here
      { controls.add( "o",     this, function() { this.thrust[2] = -1; } );     controls.add( "o",     this, function() { this.thrust[2] =  0; }, {'type':'keyup'} );
        ...
        controls.add( "w",     this, function() { this.thrust[1] = -1; } );     controls.add( "w",     this, function() { this.thrust[1] =  0; }, {'type':'keyup'} );
        controls.add( "a",     this, function() { this.thrust[0] =  1; } );     controls.add( "a",     this, function() { this.thrust[0] =  0; }, {'type':'keyup'} );
        controls.add( "s",     this, function() { this.thrust[1] =  1; } );     controls.add( "s",     this, function() { this.thrust[1] =  0; }, {'type':'keyup'} );
    ...
    'display': function( time )
      { var leeway = 70,  degrees_per_frame = .0004 * this.graphics_state.animation_delta_time,
                          meters_per_frame  =   .005 * this.graphics_state.animation_delta_time;
